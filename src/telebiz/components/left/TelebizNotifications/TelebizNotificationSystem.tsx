...
const TelebizNotificationSystem = ({
  ...
  const handleClick = useCallback(() => {
    ...
    if (notification.metadata?.welcome_message) {
      telebizOpenWelcomeModal();
    }
  }, [notification, markTelebizNotificationRead, onClick, telebizOpenWelcomeModal]);
...
export default memo(TelebizNotificationSystem);
