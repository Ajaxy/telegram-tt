...
`;function B(e,t,n){let r=e.createShader(t);if(r){if(e.shaderSource(r,n),e.compileShader(r),!e.getShaderParameter(r,e.COMPILE_STATUS)){e.deleteShader(r);return}return r}}function be(e,t,n){let r=e.createProgram();if(r){if(e.attachShader(r,t),e.attachShader(r,n),e.linkProgram(r),!e.getProgramParameter(r,e.LINK_STATUS)){e.deleteProgram(r);return}return r}}var xe=class{seed;constructor(e){this.seed=e}next(){return this.seed=(this.seed*9301+49297)%233280,this.seed/233280}nextBetween(e,t){return e+(t-e)*this.next()}},V;function Se(){if(!V){V=new Float32Array(72);for(let e=0;e<18;e++){let t=220*Math.PI/180*e,n=Math.cos(t),r=Math.sin(t);V[e*4]=n,V[e*4+1]=r,V[e*4+2]=-r,V[e*4+3]=n}}return V}function Ce(e,t){if(e instanceof k)return e;let[n,r]=e,[i,a,o]=n.coords,[s,c,l]=r.coords;return new k(`srgb`,[t.nextBetween(i||0,s||0),t.nextBetween(a||0,c||0),t.nextBetween(o||0,l||0)])}var we={sparkles:`JxY8hVTW`},Te={centerShift:[0,-36]},Ee=8,De=s(({color:e=`purple`,centerShift:t=Te.centerShift,isDisabled:n,className:r,onRequestAnimation:o})=>{let s=a(),l=a(0);return c(()=>{if(!n)return z(s.current,{color:fe[`${e}Gradient`],centerShift:t})},[t,e,n]),i(()=>{o&&o(()=>{if(n)return;let r=Date.now();r-l.current<Ee||(l.current=r,z(s.current,{color:fe[`${e}Gradient`],centerShift:t,...pe}))})},[t,e,n,o]),v(`canvas`,{ref:s,className:b(we.sparkles,r)})}),Oe={root:`CHDf16MJ`,diamond:`UM7C8oRj`},ke=``+new URL(`diamond-57JalFxA.png`,import.meta.url).href,Ae=5,je=1,Me=300,Ne=1500,H,U=!0,Pe={isCancelled:!1};function Fe({className:e,onMouseMove:n}){let[i,a]=r(je),o=m(()=>{H&&=(clearTimeout(H),void 0),H=window.setTimeout(()=>{let e=Date.now();U=!0,N(()=>{if(!U)return!1;let t=Math.min((Date.now()-e)/Ne,1),n=4*(1-Le(t));return a(n),U=t<1&&n>1,U},t,Pe)},Me),U=!1,a(Ae),n()});return v(`div`,{className:b(Oe.root,e),children:v(`div`,{className:Oe.diamond,onMouseMove:o,children:v(ee,{speed:i,size:130,tgsUrl:M.Diamond,previewUrl:ke,nonInteractive:!0,noLoop:!1})})})}var Ie=s(Fe);function Le(e){return 1-(1-e)**2}var W={root:`QcfrGLdX`,star:`nDPg-zs5`,star_purple:`-f2S1Tk6`,starPurple:`-f2S1Tk6`},Re=50;function ze({className:e,color:n,centerShift:r,onMouseMove:i}){let o=a(),s=m(e=>{let n=e.currentTarget.getBoundingClientRect(),a=n.left+n.width/2+r[0],s=n.top+n.height/2+r[1],c=e.clientX-a,l=e.clientY-s,u=Math.max(-1,Math.min(1,c/Re)),d=Math.max(-1,Math.min(1,l/Re)),f=u*40,p=-d*40;t(()=>{o.current.style.transform=`scale(1.1) rotateX(${p}deg) rotateY(${f}deg)`}),i()}),c=m(()=>{t(()=>{o.current.style.transform=``})});return v(`div`,{className:b(W.root,e),onMouseMove:s,onMouseLeave:c,children:v(`div`,{ref:o,className:b(W.star,W[`star_${n}`]),role:`img`,"aria-label":`Telegram Stars`})})}var Be=s(ze),G={root:`cK6KQXnQ`,"ai-egg":`ZP86O9Hy`,aiEgg:`ZP86O9Hy`,title:`xRm-Im3m`,description:`IQdQ9MU9`,particles:`_8ooQ3s8b`,stickerWrapper:`hHs2sTV-`,cocoon:`Rlhm9gZk`},Ve=``+new URL(`cocoon-DzgJltGQ.webp`,import.meta.url).href,K=8*p,He={centerShift:[0,-36]};function Ue({model:e,sticker:t,color:n,title:r,description:i,isDisabled:o,className:s,modelClassName:c}){let l=a(),u=a(),d=m(()=>{u.current?.()}),f=m(e=>{u.current=e});return C(`div`,{className:b(G.root,G[e],s),children:[v(De,{color:n,centerShift:He.centerShift,isDisabled:o,className:G.particles,onRequestAnimation:f}),e===`swaying-star`?v(Be,{className:c,color:n,centerShift:He.centerShift,onMouseMove:d}):e===`ai-egg`?v(`img`,{src:Ve,alt:``,role:`presentation`,"aria-hidden":`true`,className:b(G.cocoon,c),draggable:!1,onMouseMove:d}):e===`speeding-diamond`?v(Ie,{className:c,onMouseMove:d}):e===`sticker`&&t&&v(`div`,{ref:l,className:b(G.stickerWrapper,c),style:`width: ${K}px; height: ${K}px`,onMouseMove:d,children:v(A,{containerRef:l,sticker:t,size:K,shouldPreloadPreview:!0,shouldLoop:!0})}),v(`h2`,{className:G.title,children:r}),v(`div`,{className:G.description,children:i})]})}var We=s(Ue),q={root:`_7NV36hp3`,wrapper:`_32sWnI-2`,down:`DkDmNeYG`,frame:`M0hUT4cv`,video:`eWi57MWV`,placeholder:`A38HRiXg`},Ge=``+new URL(`DeviceFrame-Dqm_t18H.svg`,import.meta.url).href,Ke=s(({videoId:e,videoThumbnail:t,isActive:n,isReverseAnimation:r,isDown:i,index:a,className:o,wrapperClassName:s})=>{let c=ne(e?`document${e}`:void 0),l=oe(t?.dataUri),u=te(c);return v(`div`,{className:b(q.root,o),children:C(`div`,{className:b(q.wrapper,r&&q.reverse,i&&q.down,s),id:a===void 0?void 0:`premium_feature_preview_video_${a}`,children:[v(`img`,{src:Ge,alt:``,className:q.frame,draggable:!1}),!e&&v(`div`,{className:q.placeholder}),t&&v(`canvas`,{ref:l,className:q.video}),e&&v(re,{canPlay:!!n,className:b(q.video,u),src:c,disablePictureInPicture:!0,playsInline:!0,muted:!0,loop:!0})]})})}),J={options:`Upert7zo`,option:`_2X6-9ciP`,active:`zpGahRpW`,wideOption:`dI8-J8yI`,optionTop:`wgA5YkCl`,stackedStars:`TZ71sXrE`,stackedStar:`_6CGkOJue`,optionBottom:`GRPtw1Lm`,moreOptions:`cY6CHTaj`,iconDown:`qdRs-uv4`},qe=6,Je=s(({isActive:e,className:t,options:n,selectedStarOption:r,selectedStarCount:a,starsNeeded:o,onClick:s})=>{let c=T(),p=E(),[m,g,y]=d();i(()=>{e||y()},[e]);let[S,w]=l(()=>{if(!n)return[void 0,!1];let e=n.reduce((e,t)=>e.stars>t.stars?e:t),t=o&&e.stars<o,r=[],i=0,a=!1;return n.forEach((e,s)=>{if(e.isExtended||i++,!(o&&!t&&e.stars<o)){if(!m&&e.isExtended){a=!0;return}r.push({option:e,starsCount:Math.min(i,qe),isWide:s===n.length-1})}}),[r,a]},[m,n,o]);return C(`div`,{className:b(J.options,t),children:[S?.map(({option:e,starsCount:t,isWide:n})=>{let i=S?.length%2==0,o=e===r,l;return e&&`winners`in e&&(l=(e.winners.find(e=>e.users===a)||e.winners.reduce((e,t)=>t.users>e.users?t:e,e.winners[0]))?.perUserStars),C(`div`,{className:b(J.option,!i&&n&&J.wideOption,o&&J.active),onClick:()=>s?.(e),children:[C(`div`,{className:J.optionTop,children:[`+`,u(e.stars),v(`div`,{className:J.stackedStars,dir:p.isRtl?`ltr`:`rtl`,children:Array.from({length:t}).map(()=>v(f,{className:J.stackedStar,type:`gold`,size:`big`}))})]}),v(`div`,{className:J.optionBottom,children:D(p,e.amount,e.currency)}),(o||r&&`winners`in r)&&!!l&&v(`div`,{className:J.optionBottom,children:v(`div`,{className:J.perUserStars,children:_(c(`BoostGift.Stars.PerUser`,u(l)))})})]},e.stars)}),!m&&w&&C(x,{className:J.moreOptions,isText:!0,noForcedUpperCase:!0,onClick:g,children:[c(`Stars.Purchase.ShowMore`),v(h,{className:J.iconDown,name:`down`})]})]})}),Y={content:`j63Xdo6p`,fixedHeight:`E-xx83T0`,withSearch:`sT1YPCzK`,header:`RwB3BKcO`,buttonWrapper:`Z-xvJZEk`},Ye=`.${ie.pickerList}`,Xe=s(({confirmButtonText:e,isConfirmDisabled:t,shouldAdaptToSearch:n,withFixedHeight:r,onConfirm:i,withPremiumGradient:o,itemsContainerSelector:s=Ye,...c})=>{let l=T(),u=!!(e||i),d=a();return se({containerRef:d,selector:`.modal-content ${s}`,isBottomNotch:u,shouldHideTopNotch:!0},[c.isOpen]),C(P,{...c,dialogRef:d,isSlim:!0,className:b(n&&Y.withSearch,r&&Y.fixedHeight,c.className),contentClassName:b(Y.content,c.contentClassName),headerClassName:b(Y.header,c.headerClassName),isCondensedHeader:!0,children:[c.children,u&&v(`div`,{className:Y.buttonWrapper,children:v(x,{withPremiumGradient:o,onClick:i||c.onClose,color:`primary`,disabled:t,children:e||l(`Confirm`)})})]})}),X={table:`RMEi5Sgb`,cell:`AEl8NMjg`,title:`IypKoG1m`,value:`ZO-KCUSl`,fullWidth:`_1WIqSuNB`,chatItem:`J6it2-iy`},Ze=s(({tableData:e,className:t,onChatClick:n})=>{let{openChat:r}=S(),i=m(e=>{n?n(e):r({id:e})});if(e?.length)return v(`div`,{className:b(X.table,t),children:e.map(([e,t])=>C(g,{children:[!!e&&v(`div`,{className:b(X.cell,X.title),children:e}),v(`div`,{className:b(X.cell,X.value,!e&&X.fullWidth),children:typeof t==`object`&&`chatId`in t?v(ae,{peerId:t.chatId,className:X.chatItem,forceShowSelf:!0,withEmojiStatus:t.withEmojiStatus,clickArg:t.chatId,onClick:i}):t})]}))})}),Z={content:`rIjOLQyf`,noFooter:`ssGgYoZw`,avatar:`IdvEatvm`},Qe=s(({isOpen:e,title:t,tableData:n,headerAvatarPeer:r,header:i,modalHeader:a,footer:o,buttonText:s,className:c,contentClassName:l,tableClassName:u,hasBackdrop:d,closeButtonColor:f,moreMenuItems:p,headerRightToolBar:h,onClose:g,onButtonClick:_,withBalanceBar:y,isLowStackPriority:w,currencyInBalanceBar:T})=>{let{openChat:E}=S(),D=m(e=>{E({id:e}),g()});return C(P,{isOpen:e,hasCloseButton:!!t,hasAbsoluteCloseButton:!t,absoluteCloseButtonColor:f||(d?`translucent-white`:void 0),isSlim:!0,header:a,title:t,className:c,contentClassName:b(Z.content,l),moreMenuItems:p,headerRightToolBar:h,onClose:g,withBalanceBar:y,currencyInBalanceBar:T,isLowStackPriority:w,children:[r&&v(j,{peer:r,size:`jumbo`,className:Z.avatar}),i,v(Ze,{tableData:n,className:u,onChatClick:D}),o,s&&v(x,{className:o?void 0:Z.noFooter,onClick:_||g,children:s})]})}),Q={root:`FEEwg5rl`,secondary:`_51eeI1vd`,topIcon:`_0fVPMdEi`,premiumGradient:`oEaPoig5`,content:`_7xJ2IMc7`,listItems:`_4Smlf3-h`,listItemTitle:`lPVHA-w3`,separator:`V6iMhrLh`},$e=s(({className:e,isOpen:t,listItemData:n,headerIconName:r,headerIconPremiumGradient:i,header:a,footer:o,buttonText:s,hasBackdrop:c,absoluteCloseButtonColor:l,withSeparator:u,contentClassName:d,onClose:f,onButtonClick:p})=>C(P,{isOpen:t,className:b(Q.root,e),contentClassName:b(Q.content,d),hasAbsoluteCloseButton:!0,absoluteCloseButtonColor:l||(c?`translucent-white`:void 0),onClose:f,children:[r&&v(`div`,{className:b(Q.topIcon,i&&Q.premiumGradient),children:v(h,{name:r})}),a,v(`div`,{className:Q.listItems,children:n?.map(([e,t,n])=>C(F,{isStatic:!0,multiline:!0,icon:e,className:Q.listItem,children:[v(`span`,{className:b(`title`,Q.listItemTitle),children:t}),v(`span`,{className:`subtitle`,children:n})]}))}),u&&v(ce,{className:Q.separator}),o,!!s&&v(x,{onClick:p||f,children:s})]})),$={root:`JaXKxj2K`,arrow:`_-7ow-ETi`},et=4*p,tt=s(({fromPeer:e,toPeer:t,avatarSize:n=et})=>C(`div`,{className:$.root,children:[v(j,{peer:e,size:n}),v(h,{name:`next`,className:$.arrow}),v(j,{peer:t,size:n})]}));export{Xe as a,We as c,le as d,Ze as i,De as l,$e as n,Je as o,Qe as r,Ke as s,tt as t,ue as u};
//# sourceMappingURL=TransferBetweenPeers-DPYVCmKD.js.map